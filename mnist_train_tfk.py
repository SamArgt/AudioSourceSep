...
from flow_models import models
...
bijector_cls = layers.RealNVPStep
...
flow = models.Flow(bijector_cls, data_shape, **bijector_args)
...
#loss function
loss_fn = models.get_loss_function(flow)
